...
<ul id="menu">
    ...
    <li class="menu_right"><a href="beauty-men.php" class="drop">men</a>
...
<div id="main_container">
  ...
  <div id="main_content">
    <div class="left_sidebar">
      <div id="left_menu">
        <ul>
          <li class="selected"><a href="beauty-men.php" >beauty</a></li>
          
         
          
          <li><a href="shoes-men.php">shoes</a></li>
        </ul>
      </div>
	...
	<?php 
	 ...
	 while($row2=mysql_fetch_array($result2)){
		 ...
		 ?></select>
          ...
          <a href="http://all-free-download.com/free-website-templates/" class="details"><img src="images/details.gif" alt="" border="0" /></a> </div>
      </div>
