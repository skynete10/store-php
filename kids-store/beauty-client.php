...
<ul id="menu">
    ...
    <li class="menu_right"><a href="beauty-client.php" class="drop">Kids</a>
...
<div id="main_container">
  ...
  <div id="main_content">
    <div class="left_sidebar">
      <div id="left_menu">
        <ul>
          <li class="selected"><a href="beauty-client.php">beauty</a></li>
          
         
          
          <li><a href="toys-client.php">toys</a></li>
        </ul>
      </div>
...
<div align="left" style="min-height:800px;">
	...
	<?php 
	 ...
	 $sql="select*from products where products.cod='3-1'
