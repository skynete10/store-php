...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="UTF-8" />
        <!-- <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">  --> <title>kids</title>
    ...
    <div class="left_sidebar">
      <div id="left_menu">
        <ul>
          ...
          <li class="selected"><a href="shoes.php">toys</a></li>
        </ul>
      </div>
	...
	<?php 
	 ...
	 while($row=mysql_fetch_array($result)){
		...
		<form name="order" action="../order.php" method="post">
        		 <div class="product_box"> <img src="<?php echo $row['image'];?>" alt="" class="prod_image" />
	 ...
	 while($row1=mysql_fetch_array($result1)){
		 ...
		 ?></select>
          <font size='5px' color='#FF0000'>color:<select name='size' style="width:100px">
           <?php
		   include("../connection.php");
