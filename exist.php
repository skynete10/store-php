...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="../../Desktop/favicon.ico"> 
        <link rel="stylesheet" type="text/css" href="css-login/demo-login.css" />
        <link rel="stylesheet" type="text/css" href="css-login/style-login.css" />
		<link rel="stylesheet" type="text/css" href="css-login/animate-custom-login.css" />
    </head>
    <body>
        <div class="container">
            <!-- Codrops top bar -->
            ...
            <header>
                <h1>Store <span></span></h1>
				<nav class="codrops-demos">
					<span>Find all here</span>
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        ...
                        <div id="register" class="animate form">
                            <form  action="signup.php" name="fsignup" method="post"> 
                                ...
                                <font size="3px" color="#FF0033"> email allready exist!!</font>
                                <p> 
