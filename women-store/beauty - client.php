...
<ul id="menu">
    ...
    <li class="menu_right"><a href="../men-store/beauty-men.php" class="drop">men</a>
      ...
      <li class="menu_right"><a href="index.php" class="drop">Women</a>
...
<div id="main_container">
  ...
  <div id="main_content">
    <div class="left_sidebar">
      <div id="left_menu">
        <ul>
          <li class="selected"><a href="beauty.php">beauty</a></li>
          
          <li ><a href="index.php">swimwear</a></li>
...
<div align="left" style="min-height:800px;">
	...
	<?php 
	 ...
	 $sql="select*from products where products.cod='1-1'
